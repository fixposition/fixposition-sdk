...
static constexpr uint16_t    RTCM3_TYPE1041_MSGID           = 1041;                     //!< RTCM3-TYPE1041 message ID
static constexpr const char* RTCM3_TYPE1041_STRID           = "RTCM3-TYPE1041";         //!< RTCM3-TYPE1041 message name
